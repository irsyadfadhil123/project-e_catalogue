            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                @foreach($products['data'] as $product)
                    <a href="/product/{{ $product['id'] }}" class="group">
                        <img src="{{ $product['image'] ?? "https://www.freeiconspng.com/uploads/no-image-icon-6.png" }}" alt="Image not found." class="aspect-square w-full rounded-lg bg-gray-200 object-cover group-hover:opacity-75 xl:aspect-7/8">
                        <h3 class="mt-4 text-sm text-gray-700">{{ $product['price'] }}</h3>
                            ...
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    ...
                                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 class="text-base font-semibold text-gray-900" id="modal-title">Delete Product Success</h3>
                                        <div class="mt-2">
